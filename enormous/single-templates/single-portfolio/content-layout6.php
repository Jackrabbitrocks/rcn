...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="single-portfolio sg-portfolio-layout6">
		
		<div class="single-portfolio-body row">
			<?php if(!empty($opt_meta_options['single_portfolio_gallery'])) { ?>
				<div class="single-portfolio-image sg-gallery col-xs-12 col-sm-8 col-md-8 col-lg-8">
					<div class="sg-portfolio-masonry">
						<?php $i = 0; foreach ($image_ids as $image_id): $i++; ?>
				            <?php
					            $attachment_image = wp_get_attachment_image_src($image_id, 'full', false);
					            if($attachment_image[0] != ''):?>
					            <div class="single-portfolio-image-item cms-images-zoom col-xs-12 col-sm-6 col-md-6 col-lg-6">
