 ...
 */
?>
<div id="cshero-header-inner" class="header-6 no-trans m-style no-header-top">
        ...
        <div id="cshero-header" class="<?php enormous_header_class('cshero-main-header'); ?>">
            <div class="container">
                <div class="row">
                    ...
                    <div class="cshero-navigation-right pull-right text-right col-lg-2 col-md-2 col-sm-12 col-xs-12 hidden-xs hidden-sm">
