...
class CS_Social_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            ...
            esc_html__('Social', 'enormous'), // Name
            array('description' => esc_html__('Social Widget', 'enormous'),) // Args
        );
    }
    ...
    function widget($args, $instance) {
        ...
        $title = apply_filters('widget_title', empty($instance['title']) ? esc_html__('Social', 'enormous' ) : $instance['title'], $instance, $this->id_base);
        }
        ...
        if ($link_facebook != '') {
            echo '<li class="facebook"><a target="_blank" data-rel="tooltip" data-placement="bottom" data-original-title="'.esc_html__('Facebook', 'enormous').'" href="'.esc_url($link_facebook).'"><i class="'.$icon_facebook.'"></i></a></li>';
        }

        if ($link_rss != '') {
            echo '<li class="rss"><a target="_blank" data-rel="tooltip" data-placement="bottom" data-original-title="'.esc_html__('Rss', 'enormous').'" href="'.esc_url($link_rss).'"><i class="'.$icon_rss.'"></i></a></li>';
        }
        if ($link_twitter != '') {
            echo '<li class="twitter"><a target="_blank" data-rel="tooltip" data-placement="bottom" data-original-title="'.esc_html__('Twitter', 'enormous').'" href="'.esc_url($link_twitter).'"><i class="'.$icon_twitter.'"></i></a></li>';
        }

        if ($link_youtube != '') {
            echo '<li class="youtube"><a target="_blank" data-rel="tooltip" data-placement="bottom" data-original-title="'.esc_html__('YouTube', 'enormous').'" href="'.esc_url($link_youtube).'"><i class="'.$icon_youtube.'"></i></a></li>';
        }

        

        if ($link_google != '') {
            echo '<li class="google"><a target="_blank" data-rel="tooltip" data-placement="bottom" data-original-title="'.esc_html__('Google', 'enormous').'" href="'.esc_url($link_google).'"><i class="'.$icon_google.'"></i></a></li>';
        }

        if ($link_skype != '') {
            echo '<li class="skype"><a target="_blank" data-rel="tooltip" data-placement="bottom" data-original-title="'.esc_html__('Skype', 'enormous').'" href="'.esc_url($link_skype).'"><i class="'.$icon_skype.'"></i></a></li>';
        }

        if ($link_yahoo != '') {
            echo '<li class="yahoo"><a target="_blank" data-rel="tooltip" data-placement="bottom" data-original-title="'.esc_html__('Yahoo', 'enormous').'" href="'.esc_url($link_yahoo).'"><i class="'.$icon_yahoo.'"></i></a></li>';
        }

        if ($link_dribbble != '') {
            echo '<li class="dribbble"><a target="_blank" data-rel="tooltip" data-placement="bottom" data-original-title="'.esc_html__('Dribbble', 'enormous').'" href="'.esc_url($link_dribbble).'"><i class="'.$icon_dribbble.'"></i></a></li>';
        }

        if ($link_flickr != '') {
            echo '<li class="flickr"><a target="_blank" data-rel="tooltip" data-placement="bottom" data-original-title="'.esc_html__('Flickr', 'enormous').'" href="'.esc_url($link_flickr).'"><i class="'.$icon_flickr.'"></i></a></li>';
        }

        if ($link_linkedin != '') {
            echo '<li  class="linkedin"><a target="_blank" data-rel="tooltip" data-placement="bottom" data-original-title="'.esc_html__('Linkedin', 'enormous').'" href="'.esc_url($link_linkedin).'"><i class="'.$icon_linkedin.'"></i></a></li>';
        }

        if ($link_vimeo != '') {
            echo '<li class="vimeo"><a target="_blank" data-rel="tooltip" data-placement="bottom" data-original-title="'.esc_html__('Vimeo', 'enormous').'" href="'.esc_url($link_vimeo).'"><i class="'.$icon_vimeo.'"></i></a></li>';
        }

        if ($link_pinterest != '') {
            echo '<li class="pinterest"><a target="_blank" data-rel="tooltip" data-placement="bottom" data-original-title="'.esc_html__('Pinterest', 'enormous').'" href="'.esc_url($link_pinterest).'"><i class="'.$icon_pinterest.'"></i></a></li>';
        }

        if ($link_github != '') {
            echo '<li class="github"><a target="_blank" data-rel="tooltip" data-placement="bottom" data-original-title="'.esc_html__('Github', 'enormous').'" href="'.esc_url($link_github).'"><i class="'.$icon_github.'"></i></a></li>';
        }

        if ($link_instagram != '') {
            echo '<li class="instagram"><a target="_blank" data-rel="tooltip" data-placement="bottom" data-original-title="'.esc_html__('Instagram', 'enormous').'" href="'.esc_url($link_instagram).'"><i class="'.$icon_instagram.'"></i></a></li>';
        }
    ...
    function form( $instance ) {
         ...
         ?>
         <p><label for="<?php echo esc_url($this->get_field_id('title')); ?>"><?php esc_html_e( 'Title:', 'enormous' ); ?></label>
         <input class="widefat" id="<?php echo esc_attr( $this->get_field_id('title') ); ?>" name="<?php echo esc_attr( $this->get_field_name('title') ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" /></p>

         <p><label for="<?php echo esc_url($this->get_field_id('icon_facebook')); ?>"><?php esc_html_e( 'Icon Facebook:', 'enormous' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_facebook')); ?>"><?php esc_html_e( 'Link Facebook:', 'enormous' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_rss')); ?>"><?php esc_html_e( 'Icon rss:', 'enormous' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_rss')); ?>"><?php esc_html_e( 'Link rss:', 'enormous' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_youtube')); ?>"><?php esc_html_e( 'Icon youtube:', 'enormous' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_youtube')); ?>"><?php esc_html_e( 'Link youtube:', 'enormous' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_twitter')); ?>"><?php esc_html_e( 'Icon twitter:', 'enormous' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_twitter')); ?>"><?php esc_html_e( 'Link twitter:', 'enormous' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_google')); ?>"><?php esc_html_e( 'Icon google:', 'enormous' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_google')); ?>"><?php esc_html_e( 'Link google:', 'enormous' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_skype')); ?>"><?php esc_html_e( 'Icon skype:', 'enormous' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_skype')); ?>"><?php esc_html_e( 'Link skype:', 'enormous' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_yahoo')); ?>"><?php esc_html_e( 'Icon yahoo:', 'enormous' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_yahoo')); ?>"><?php esc_html_e( 'Link yahoo:', 'enormous' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_dribbble')); ?>"><?php esc_html_e( 'Icon dribbble:', 'enormous' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_dribbble')); ?>"><?php esc_html_e( 'Link dribbble:', 'enormous' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_flickr')); ?>"><?php esc_html_e( 'Icon flickr:', 'enormous' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_flickr')); ?>"><?php esc_html_e( 'Link flickr:', 'enormous' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_linkedin')); ?>"><?php esc_html_e( 'Icon linkedin:', 'enormous' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_linkedin')); ?>"><?php esc_html_e( 'Link linkedin:', 'enormous' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_vimeo')); ?>"><?php esc_html_e( 'Icon vimeo:', 'enormous' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_vimeo')); ?>"><?php esc_html_e( 'Link vimeo:', 'enormous' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_pinterest')); ?>"><?php esc_html_e( 'Icon pinterest:', 'enormous' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_pinterest')); ?>"><?php esc_html_e( 'Link pinterest:', 'enormous' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_github')); ?>"><?php esc_html_e( 'Icon github:', 'enormous' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_github')); ?>"><?php esc_html_e( 'Link github:', 'enormous' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_instagram')); ?>"><?php esc_html_e( 'Icon instagram:', 'enormous' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_instagram')); ?>"><?php esc_html_e( 'Link instagram:', 'enormous' ); ?></label>
