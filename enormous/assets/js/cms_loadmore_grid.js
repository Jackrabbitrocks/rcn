	...
	$('.cms-grid-wraper').each(function(){
		...
		if(typeof cms_variable != 'undefined'){
			...
			if(pageNum[html_id] <= max[html_id]) {
				...
				$('#'+html_id +' .cms_pagination').append('<div class="cms-placeholder-'+ pageNum[html_id] +'"></div><div class="cms-load-posts"><a class="btn btn-no-style"data-loading="0" href="#">'+text+'</a></div>');
			}
