...
?>
<div class="cms-carousel layout-testimonial layout-testimonial1 <?php echo esc_attr($cms_style); ?> <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
    <?php
    $posts = $atts['posts'];
