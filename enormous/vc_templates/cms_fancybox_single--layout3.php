...
?>
<div class="cms-fancyboxes-wraper fancyboxes-layout3 <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">    
    <div class="cms-fancyboxes-body">
        <div class="cms-fancybox-item">
            ...
            <div class="cms-fancybox-content">
                <?php if($atts['f_sub_title']):?>
                <div class="fancy-box-subtitle">
                    <?php echo apply_filters('the_title',$atts['f_sub_title']);?>
                </div>
                <?php endif;?>
