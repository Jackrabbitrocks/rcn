<?php 
    ...
    $content_bg_color = isset($atts['content_bg_color']) ? $atts['content_bg_color'] : '';
?>
<div class="cms-fancyboxes-wraper fancyboxes-layout6 <?php echo esc_attr($f_style); ?> <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">    
    <div class="cms-fancyboxes-body">
        <div class="cms-fancybox-item" style="background-color: <?php echo esc_attr($content_bg_color); ?>">
            ...
            <div class="cms-fancybox-item-hover"></div>
        </div>
    </div>
</div>