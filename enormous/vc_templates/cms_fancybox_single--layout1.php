<?php 
    ...
    $cms_style = isset($atts['cms_style']) ? $atts['cms_style'] : 'style-light';
?>
<div class="cms-fancyboxes-wraper fancyboxes-layout1 <?php echo esc_attr($atts['template']);?> <?php echo esc_attr($cms_style); ?>" id="<?php echo esc_attr($atts['html_id']);?>">       
