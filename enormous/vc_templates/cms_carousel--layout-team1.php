...
?>
<div data-padding="0" class="cms-carousel layout-team layout-team1 <?php echo esc_attr($atts['template']);?> <?php echo esc_attr($cms_style); ?>" id="<?php echo esc_attr($atts['html_id']);?>">
    <?php
    $posts = $atts['posts'];
    while($posts->have_posts()){
        ...
        <div class="cms-team-item">
            <div class="cms-team-image">
                ...
                ?>
                <div class="cms-team-overlay"><a class="overlay-inner" href="<?php the_permalink(); ?>"><?php esc_html_e( 'Contact', 'enormous' ); ?></a> </div>    
            </div>         
            <div class="cms-team-content">
                ...
                <div class="cms-team-intro">
                    <div class="cms-team-description">
