<?php 
    ...
    $f_title_fontweight = isset($atts['f_title_fontweight']) ? $atts['f_title_fontweight'] : '';
?>
<div class="cms-fancyboxes-wraper fancyboxes-layout12 <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">    
    <div class="cms-fancyboxes-body">
        <div class="cms-fancybox-item">
            <?php 
                $image_url = '';
                if (!empty($atts['image'])) {
                    $attachment_image = wp_get_attachment_image_src($atts['image'], 'enormous_1110X720');
            ...
            <div class="cms-fancybox-content">
                <?php if (!empty($atts['f_sub_title'])):?>
                    <div class="sub-title"><?php echo esc_attr($f_sub_title); ?></div>
                <?php endif;?>
                <?php if($atts['title_item']):?>
                <h4 class="fancy-box-title" style="font-size: <?php echo esc_attr($f_title_fontsize);?>;font-weight: <?php echo esc_attr($f_title_fontweight);?>;color: <?php echo esc_attr($f_title_color);?>; margin-bottom: <?php echo esc_attr($space_bottom_title);?>; margin-top: <?php echo esc_attr($space_top_title);?>">
