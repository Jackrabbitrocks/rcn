...
?>
<div class="cms-fancyboxes-wraper fancyboxes-layout8 <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">    
    <div class="cms-fancyboxes-body">     
        <div class="cms-fancybox-item">
            ...
            <div class="cms-fancybox-content">
                <div class="cms-fancybox-content-top">
                    <div class="cms-fancybox-content-top-left">
                    ...
                    <div class="cms-fancybox-number">
                        <?php if (!empty($atts['f_number'])):?>
                            <span><?php echo esc_attr($f_number); ?></span>
                        <?php endif;?>
                    </div>
                </div>
