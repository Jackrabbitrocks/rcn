...
?>
<div class="cms-grid-wraper cms-grid-default <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
    ...
    <div class="row cms-grid <?php echo esc_attr($atts['grid_class']);?>">
        ...
        while($posts->have_posts()){
            ...
            <div class="cms-grid-item <?php echo esc_attr($atts['item_class']);?>" data-groups='[<?php echo implode(',', $groups);?>]'>
                ...
                ?>
                <div class="cms-grid-content" style="text-align: <?php echo esc_attr($text_align);?>">
                    <h3 class="cms-grid-title">
                        <a href="<?php the_permalink(); ?>"><?php the_title();?></a>  
                    </h3>
                    <div class="cms-grid-des">
                        <?php echo substr(get_the_excerpt(), 0,150); ?>     
                    </div>
                    <div class="cms-grid-readmore">
