...
?>
<div class="cms-fancyboxes-wraper fancyboxes-layout10 <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">    
            ...
            <div class="cms-fancybox-content">
                ...
                <?php if($atts['button_text']!=''):?>
                    <div class="cms-fancyboxes-foot">
                        ...
                        ?>
                        <a href="<?php echo esc_url($atts['button_link']);?>" class="btn btn-white-alt btn-xs<?php echo esc_attr($class_btn);?>" style="color: <?php echo esc_attr($f_button_color);?>"><?php echo esc_attr($atts['button_text']);?></a>
                    </div>
                <?php endif;?>
            </div>
        </div>
